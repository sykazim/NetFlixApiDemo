...
public class Statistics {
	...
	public static List<NetflixData> listRecordsByType(String type, int n, Date startDate, Date endDate) throws NumberFormatException, IOException, ParseException {
		List<NetflixData> firstNRecords = new ArrayList<>();
		int counter = 0;
		for (NetflixData data : netflixDataList) {
